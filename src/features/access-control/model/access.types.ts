...
export interface IdentityAccessSnapshot {
  ...
  rolePermissions: RolePermissionBinding[];
}
...
export interface IdentityUserPageFilter {
  search?: string;
  status?: UserStatus;
  page?: number;
  pageSize?: number;
}
export interface IdentityRolePageFilter {
  search?: string;
  isActive?: boolean;
  page?: number;
  pageSize?: number;
}
export interface IdentityAssignmentPageFilter {
  userId?: string;
  userIds?: string[];
  roleId?: string;
  isActive?: boolean;
